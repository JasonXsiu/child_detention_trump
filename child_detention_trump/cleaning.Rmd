...
```{r Read the file}
df_detention <- read.csv(file = "/users/rounakagarwal/desktop/ETC1010_M3/detention_original.csv")
...
df_reddit <- read.csv(file = "/users/rounakagarwal/desktop/ETC1010_M3/reddit_original.csv")
```
